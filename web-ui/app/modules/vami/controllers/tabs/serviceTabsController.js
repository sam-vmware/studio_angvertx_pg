'use strict';
//vamiApp.lazy.controller('serviceTabsController', ['$q', '$scope', function ($q, $scope ) {
vamiApp.controller('serviceTabsController', ['$q', '$log', '$scope', '$state', 'VAMI_ROOT',
    function ($q, $log, $scope, $state, VAMI_ROOT) {
        $scope.tabs = [
            ...
            { title: "Network", name: "network", state: "serviceTabs.network", active: false, disabled: true, templ: VAMI_ROOT + '/views/tabs/networkTab.html' }
        ];
        ...
        $scope.active = function() {
            return $scope.tabs[$scope.index].name;
        };
        */
